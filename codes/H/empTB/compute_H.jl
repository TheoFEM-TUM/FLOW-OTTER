...
function compute_H(N_unitcells::Int, n_atoms::Int, n_orbitals::Int, positions::Array{Float64}, SOC::Vector{Float64}, L::Vector{Float64}, hop_fit::Array{Float64}, q::Vector{Float64}, nn::Dict{Int, Vector{Int}}, nn_cell::Dict{Int, Vector{Int}}, unit_cell::Dict{Int, Vector{Int}})
    ...
    return indices, hamiltonian, mean_onsites_Pb, mean_onsites_Ha
end
...
function main(path::String, snapshot::Int, path_SOC::String, N_unitcells::Int, n_atoms::Int, n_orbitals::Int)
    ...
    indices, hamiltonian, mean_onsites_Pb, mean_onsites_Ha = compute_H(N_unitcells, n_atoms, n_orbitals, positions, SOC, L, hop_fit, q, nn, nn_cell, unit_cell)
